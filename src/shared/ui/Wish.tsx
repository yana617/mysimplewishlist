...
import { Wish as WishType } from '../api/models';
import { deleteWishById, updateList } from '../api';
...
export const Wish = ({ id, label, checked, list_id, link, isMyList }: WishType & { isMyList: boolean }) => {
